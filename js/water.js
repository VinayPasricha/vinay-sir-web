/**
 * Three.js Water shader — ported from examples/jsm/objects/Water.js (r160)
 * Adapted for UMD / global THREE usage.
 *
 * Based on:
 *   https://github.com/Slayvin: Flat mirror for three.js
 *   https://home.adelphi.edu/~stemkoski/ : Water shader
 *   http://29a.ch/ : WebGL water
 */
(function () {
  'use strict';

  const {
    Color, FrontSide, Matrix4, Mesh, PerspectiveCamera, Plane,
    ShaderMaterial, UniformsLib, UniformsUtils, Vector3, Vector4,
    WebGLRenderTarget
  } = THREE;
